class RolesModel {
  ...
  RolesModel(
      ...
      required this.viewAccount,
      required this.addStock,
      required this.cToUsedItem,
      required this.cToFaulty,
      required this.cToDiscard,
      required this.viewDemand,
      required this.addDemand});
  ...
  Map<String, dynamic> toRoleMap() {
    var map = <String, dynamic>{
      colRoleName: roleType,
      colRoleId: roleId,
      colAddAccount: addAccount,
      colViewAccount: viewAccount,
      colAddStock: addStock,
      colCToUsedItem: cToUsedItem,
      colCToFaulty: cToFaulty,
      colToDiscard: cToDiscard,
      colAddDemand: addDemand,
