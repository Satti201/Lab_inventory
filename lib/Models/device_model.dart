...
class DeviceModel{
  ...
  DeviceModel({required this.deviceId, required this.deviceName, required this.deviceTypeId
    , required this.company, required this.deviceType, required this.size,
    required this.deviceBarcode, required this.containerBarcode, required this.deviceStatus, required this.qty,
  ...
  Map<String, dynamic> toRoleMap() {
    var map = <String, dynamic>{colDeviceId: deviceId, colDeviceName: deviceName,
      colDeviceTypeId: deviceTypeId, colCompany: company, colDeviceType: deviceType,
      colSize: size, colDeviceBarcode: deviceBarcode, colContainerBarcode: containerBarcode,
      colDeviceStatus: deviceStatus, colQty: qty, collocationId: locationId};
    return map;
  }
